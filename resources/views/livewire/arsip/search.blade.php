<div>
    ...
    <div wire:loading.flex wire:target="openViewModal" class="fixed inset-0 z-[9999] bg-zinc-900/60 items-center justify-center" style="top: 0; left: 0; right: 0; bottom: 0;">
        <div class="bg-white rounded-xl p-8 flex flex-col items-center gap-4 shadow-2xl">
            ...
            <span class="text-base font-medium text-zinc-700">Memuat detail arsip...</span>
        </div>
    </div>
