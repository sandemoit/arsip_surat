        ...
        @forelse ($archives as $index => $archive)
            ...
            <x-datatable.row>
                ...
                <x-datatable.cell center>
                    @if($archive->category)
                        <span class="inline-flex px-2.5 py-1 text-xs font-medium rounded-full {{ $archive->category->badge_classes }}">
                ...
                <x-datatable.cell center>
                    <span class="inline-flex px-2.5 py-1 text-xs font-medium rounded-full {{ $statusBadge['bg'] }} {{ $statusBadge['text'] }}">
                        {{ $statusBadge['label'] }}
                    </span>
                </x-datatable.cell>
                ...
                <x-datatable.cell center>
                    <div class="flex items-center justify-center gap-1">
                        ...
                        @if($archive->canBeDisposed())
                            ...
                            >
                                <svg wire:loading.remove wire:target="openDisposisiModal('{{ $archive->id }}')" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/>
                                </svg>
                                <svg wire:loading wire:target="openDisposisiModal('{{ $archive->id }}')" class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                            </button>
